...
with Session(autoflush=False, bind=engine) as view:
    ...
    # view.add_all([comp_1, comp_2, comp_3, comp_4, comp_5, comp_6, comp_7, comp_8, comp_9, comp_10, comp_11, comp_12, comp_13, comp_14, comp_15, comp_16, comp_17, comp_18, comp_19, comp_20])
    # view.commit() 
    
    q = view.query(Computer.model, Computer.speed, Computer.hd).filter(Computer.prise < 500).all()
    print(q)
